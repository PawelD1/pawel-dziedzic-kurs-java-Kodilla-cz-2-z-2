...
public class TrelloFacadeTest {
    ...
    public void shouldCreateCard() {
        ...
        //when
        CreatedTrelloCardDto resultedCard = trelloFacade.createCard(trelloCardDto);

        //Then
        assertEquals("id", resultedCard.getId());
        assertEquals("name", resultedCard.getName());
        assertEquals("shortUrl", resultedCard.getShortUrl());
    }
}